...
XCO2 = 0
R = 8.314
P0 = 3              #Pression totale initiale (bar)
X0 = 0
PCaO = P * XCaO
PCH4 = P * XCH4
PH2O = P * XH2O
...
etatsInitiaux = (CH4, H2O, H2, CO, CO2, X, T, P)
k0z = kg * (epsilon + ((1 - epsilon)/((0.139 * epsilon) - 0.0339 + (2/3) * (kg/ks))))
C0tot = 1/22.4      #Pression totale en z = O (1/22,4 mol/L ou kmol/m^3)
C0CaO = 0
C0CH4 = 1/4 * C0tot
C0H2O = 3/4 * C0tot 
C0H2 = 0
C0CO = 0
C0CO2 = 0
C0 = [C0CH4,C0H2O,C0H2,C0CO,C0CO2,X0,T0,P0]       #Tableau des états initiaux 
Ctot = 1/22.4      #Pression totale en z = O (1/22,4 mol/L ou kmol/m^3)
CCH4 = 1/4 * Ctot #Concentration de CH4
CH2O = 3/4 * Ctot      #Concentration de H2O
CH2 = 0      #Concentration de H2
CCO = 0      #Concentration de CO
CCO2 = 0     #Concentration de CO2
...
C0 = [CCH4,CH2O,CH2,CCO,CCO2,X,T,P]       #Tableau des états initiaux 